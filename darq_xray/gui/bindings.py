...
* ``STAGE_ORDER`` / ``STAGE_SPECS`` — the stages the GUI exposes and their
  parameter schemas.
* ``experiment_overrides`` — how an :class:`~darq_xray.config.models.Experiment`
...
Run targets themselves come from :data:`darq_xray.stages.registry.STAGE_TARGETS`.
"""
...
from darq_xray.common.roi import analysis_detector_window, format_pair, parse_pair
from darq_xray.config.models import Experiment, StageSpec
from darq_xray.stages import (
    concat,
    matched,
    mosaicity,
    paraview,
