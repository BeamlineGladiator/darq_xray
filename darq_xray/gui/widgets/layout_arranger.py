...
A horizontal strip of columns over a GridModel (``darq_xray.compose.gridmap``):
...
def _collect_col_flags(layout) -> dict[frozenset, dict]:
    ...
    from darq_xray.compose.recipe import Col, PanelRef, Row
...
class ArrangeDialog(QDialog):
    ...
    def __init__(self, recipe, style, parent=None) -> None:
        super().__init__(parent)
        from darq_xray.compose.gridmap import flatten_panel_ids, layout_to_grid, panel_group_hint
    ...
    def _on_apply(self) -> None:
        from darq_xray.compose.gridmap import grid_to_layout
