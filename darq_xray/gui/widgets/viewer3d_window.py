...
:class:`~darq_xray.common.render3d.Scene3D`; closing the window closes the plotter
...
from darq_xray.common import cmaps as _cmaps
from darq_xray.common import render3d as R3
from darq_xray.runner import Done, Failed, Progress, StageRunner
...
class Viewer3DWindow(QWidget):
    ...
    def _on_save_video(self) -> None:
        ...
        self._video_runner = StageRunner("darq_xray.viewer_jobs:rotation_video_job", job)
