...
from darq_xray.config.models import EXPERIMENT_SCHEMA, Experiment
...
class ExperimentDialog(QDialog):
    ...
    def _roi_problems(self) -> list[str]:
        from darq_xray.common.roi import validate_rois
    ...
    def _detect(self, vals: dict) -> list:
        ...
        from darq_xray.config.detect import detect_experiment
    ...
    def _on_pick_analysis_roi(self) -> None:
        from darq_xray.common.figures import stacked_volume_previews
        from darq_xray.common.roi import parse_pair
