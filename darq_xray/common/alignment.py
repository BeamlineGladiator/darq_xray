...
from darq_xray.common import raster, volumeio
...
def roi_shape_for_params(
    ...
    unknown — :func:`~darq_xray.common.advisory._aligned_shape_for_hint` falls back
...
def aligned_shape_for_params(
    ...
    *ref_pattern_key* names the folder pattern whose FIRST scan anchors the
    ...
    :func:`~darq_xray.common.advisory._aligned_shape_for_hint` (the 3-D texture-cap
