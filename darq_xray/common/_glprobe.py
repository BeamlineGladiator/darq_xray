"""Out-of-process OpenGL capability probe. Run as ``python -m darq_xray.common._glprobe``.
...
(:mod:`darq_xray.common.machine`) treats "child died" as a normal answer meaning
"3-D unusable".
...
:func:`darq_xray.common.machine.is_software_renderer`, the single owner of that
rule.
