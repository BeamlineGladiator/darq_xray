...
class CostEstimate:
    ...
    (:func:`~darq_xray.common.raster.motor_positions_for_estimate`); a run never uses
    that cache.
...
class StageSpec:
    ...
    def estimator(self):
        ...
        if self.estimate is None:
            return None
        from darq_xray.stages.registry import resolve
...
class Experiment:
    ...
    # --- regions of interest (frames + conversions: darq_xray/common/roi.py) ------
