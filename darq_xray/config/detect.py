...
:class:`~darq_xray.config.models.Experiment` (typically the live form values) and
...
def detect_pixel_sizes(scan_h5: str, positioners_path: str, entry_suffix: str) -> list[Detection]:
    """Pixel sizes X/Y via :func:`~darq_xray.common.pixel_size.compute_pixel_size`.
...
def find_strain_maps(
    ...
    """
    from darq_xray.common.sort import find_matching_folders
...
def detect_ccmth_from_positioners(
    ...
    from darq_xray.common.h5io import get_filtered_entries, read_positioners
