...
**Tech Stack:** Python 3.10, numpy, h5py, scipy, PySide6 (GUI, not exercised by `pytest -q`), ruff, pytest. Run from repo root `/home/albert/Desktop/dfxm_pipeline` on branch `remove-mu-strain-term`.
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && python3 -m pytest tests/test_stage_strain.py -q`
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && python3 -m pytest tests/test_stage_strain.py -q && python3 -m pytest -q`
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && ~/.local/bin/ruff check dfxm/stages/strain.py gui/stage_view.py gui/bindings.py tests/test_stage_strain.py`
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && python3 -m pytest tests/test_config.py -q`
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && python3 -m pytest tests/test_config.py -q && python3 -m pytest -q`
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && ~/.local/bin/ruff check dfxm/config/models.py dfxm/config/presets.py gui/experiment_panel.py tests/test_config.py`
Expected: clean.
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && grep -rni "mu_ref\|11.5015\|11.2491\|ccmth_mu" docs/Usage.md docs/Codebase.md`
Expected: no matches.
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && python3 -m pytest -q`
Expected: all pass; the two `_legacy` strain tests report as skipped.

- [ ] **Step 2: GUI smoke (not auto-collected by pytest)**

Run: `cd /home/albert/Desktop/dfxm_pipeline && QT_QPA_PLATFORM=offscreen python3 tests/gui_smoke.py`
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && ~/.local/bin/ruff check .`
Expected: clean.

- [ ] **Step 4: CLI no longer advertises mu/method**

Run: `cd /home/albert/Desktop/dfxm_pipeline && python3 -m dfxm.stages.strain -h`
Expected: help text shows no `--method` and no `--mu-ref`.

- [ ] **Step 5: Residual-reference scan**

Run: `cd /home/albert/Desktop/dfxm_pipeline && grep -rni "mu_ref\|ccmth_mu\|11.5015\|11.2491" dfxm/ gui/ experiments/ tests/ docs/Usage.md docs/Codebase.md | grep -v "superpowers/specs\|superpowers/plans"`
...
Run: `cd /home/albert/Desktop/dfxm_pipeline && grep -n "mu_com_path" dfxm/stages/mosaicity.py`
